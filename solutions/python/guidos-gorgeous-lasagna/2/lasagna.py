...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    Parameters:
        ...
        elapsed_bake_time (int): Time the lasagna has been baking in the over.

    Returns:
        int: The total time elapsed (in minutes) preparing and baking.

    This function takes two integers representing the number of lasagna layers
    and the time already spent baking the lasagna. It calculates the total elapsed minute
